...
<body>
  <header>
    <img src="logo.png" alt="Logo Pizzeria Palato Partenopeo" class="logo" />
  </header>
  ...
  <section class="menu-section">
    <h2>Antipasti</h2>
    <div class="item">
      <img src="bruschette_miste.jpg" alt="Bruschette miste" class="item-image" />
    ...
    <div class="item">
      <img src="tagliere_salumi_formaggi.jpg" alt="Tagliere di salumi e formaggi" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="frittura_calamari_gamberi.jpg" alt="Frittura di calamari e gamberi" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="mozzarella_incarrozza.jpg" alt="Mozzarella in carrozza" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="polpette_della_nonna.jpg" alt="Polpette della nonna" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="caprese.jpg" alt="Caprese" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="crostino_ai_funghi.jpg" alt="Crostini ai funghi" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="insalata_di_mare.jpg" alt="Insalata di mare" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="olive_ascolane.jpg" alt="Olive ascolane" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="carpaccio_bresaola.jpg" alt="Carpaccio di bresaola" class="item-image" />
      <div class="item-header">
...
<section class="menu-section">
  ...
  <div class="item-row">
    <div class="item">
      <img src="margherita.jpg" alt="Margherita" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="diavola.jpg" alt="Diavola" class="item-image" />
      <div class="item-header">
  ...
  <div class="item-row">
    <div class="item">
      <img src="capricciosa.jpg" alt="Capricciosa" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="quattro_stagioni.jpg" alt="Quattro Stagioni" class="item-image" />
      <div class="item-header">
  ...
  <div class="item-row">
    <div class="item">
      <img src="funghi.jpg" alt="Funghi" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="marinara.jpg" alt="Marinara" class="item-image" />
      <div class="item-header">
  ...
  <div class="item-row">
    <div class="item">
      <img src="napoli.jpg" alt="Napoli" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="prosciutto_cotto.jpg" alt="Prosciutto Cotto" class="item-image" />
      <div class="item-header">
  ...
  <div class="item-row">
    <div class="item">
      <img src="caprese_pizza.jpg" alt="Caprese" class="item-image" />
      <div class="item-header">
        <span class="item-name">Caprese</span>
        <span class="item-price">€8.00</span>
      </div>
    ...
    <div class="item">
      <img src="rucola.jpg" alt="Rucola" class="item-image" />
      <div class="item-header">
    ...
    <div class="item-row">
    <div class="item">
      <img src="pizza_crocche.jpg" alt="Crocchettone" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="wurstel_patatine.jpg" alt="Wurstel e Patatine" class="item-image" />
      <div class="item-header">
  ...
  <section class="menu-section">
    <h2>Dolci</h2>
    <div class="item">
      <img src="tiramisu.jpg" alt="Tiramisù" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="panna_cotta.jpg" alt="Panna Cotta" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="cannoli_siciliani.jpg" alt="Cannoli Siciliani" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="crostata.jpg" alt="Crostata" class="item-image" />
      <div class="item-header">
    ...
    <div class="item">
      <img src="gelato.jpg" alt="Gelato" class="item-image" />
      <div class="item-header">
